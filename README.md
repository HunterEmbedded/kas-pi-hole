...
From a another PC copy the new .raucb file to /data on the RPi4

```
scp build/tmp/deploy/images/raspberrypi4-64/pi-hole-image-6.0.6-raspberrypi4-64-<timestamp>.raucb admin@<RPI4 IP>:/data/pi-hole-bundle.raucb
```
...
```
rauc install /data/pi-hole-bundle.raucb
rauc status mark-active other
sudo rm /data/pi-hole-bundle.raucb
